...
_os_fisheye = CameraConfig(2688 // 2, 1520 // 2, 567.0 * 3 / 4 )
_ar_ox_config = DeviceCameraConfig(CameraConfig(1928, 1208, 2648.0), _ar_ox_fisheye, _ar_ox_fisheye)
_os_config = DeviceCameraConfig(CameraConfig(2688 // 2, 1520 // 2, 2648.0 * 3 / 4), _os_fisheye, _os_fisheye)
_os_config_mici = DeviceCameraConfig(CameraConfig(2688 // 2, 1520 // 2, 1522.0 * 3 / 4), _os_fisheye, _os_fisheye)
...
prods = itertools.product(('tici', 'tizi', 'tiki', 'mici'),
                          (('ar0231', _ar_ox_config), ('ox03c10', _ar_ox_config), ('os04c10', _os_config), ('os04c10', _os_config_mici)))
